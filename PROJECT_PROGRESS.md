...
## Completed
- [SAM_BHoM#7](https://github.com/SAM-BIM/SAM_BHoM/pull/7) merged as `26eba32d`: removed dead .NET Framework `app.config` files.
...
## Files changed
- `Grasshopper/SAM.Analytical.Grasshopper.BHoM/app.config` (deleted)
